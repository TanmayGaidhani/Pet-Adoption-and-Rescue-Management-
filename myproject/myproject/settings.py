...
# SQLite for Django sessions/admin only
# All app data (users, reports, etc.) is stored in MongoDB via PyMongo in models.py
DATABASES = {
    'default': {
...
# Messages fallback storage (cookies + session fallback)
MESSAGE_STORAGE = 'django.contrib.messages.storage.fallback.FallbackStorage'

# Email via Brevo API (handled in utils/email.py)
